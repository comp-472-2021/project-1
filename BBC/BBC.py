...
output.write("More detailed macro-average F1: " + str(f1_score(y_test, y_predict, average="micro")) + "\n")
output.write("More detailed weighted-average F1: " + str(f1_score(y_test, y_predict, average="weighted")) + "\n")
